...
SC_MODULE (TOP) {
  ...
  // signals
  sc_clock clk;
  sc_signal<sc_logic> data_valid_source, data_req_source, data_valid_sink, data_req_sink;
 ...
 SC_CTOR(TOP)
   ...
   data_imag_in("imag_in"),
   data_imag_out("imag_out"),
   data_real_in("real_in"),
   data_real_out("real_out"),
   data_valid_source("valid_source"),
   data_req_source("req_source"),
